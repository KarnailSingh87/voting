...
const WhatsAppSettings = ({ token }) => {
    ...
    // Placeholder for future phone number linking support
    const handleLinkWithCode = async () => {
      toast.info('Phone number linking is not yet implemented in the backend.\n\nThis feature requires Baileys (WhatsApp library) to support phone number code login. Currently, only QR code login is available.');
    };
                    ...
                    <div>
                      {!showCodeEntry ? (
                        ...
                        <div className="flex flex-col items-center py-6 sm:py-8 w-full max-w-xs mx-auto">
                          ...
                          {/* Desktop phone number linking instructions removed as requested */}
                          ...
                          <button
                            ...
                            disabled
                            className="w-full sm:w-auto px-4 py-2 bg-gray-400 text-white rounded-lg cursor-not-allowed opacity-60 mb-2"
                          >
                            Link Device (Coming Soon)
                          </button>
                          <div className="text-xs text-red-700 bg-red-50 rounded p-2 mt-2 text-center">
                            <b>Note:</b> Linking with phone number is not yet supported in this admin panel.<br/>
                            This feature will be enabled when the WhatsApp backend library (Baileys) adds support for phone number code login.<br/>
                            For now, please use the QR code method.
                          </div>
                        </div>
                      )}
                    </div>
